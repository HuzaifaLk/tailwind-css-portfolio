...
//             <p data-aos="fade-right" className="text-white">I am</p>
//             <p data-aos="fade-right" className="text-white">Muhammad</p>
//             <p data-aos="fade-right" className="text-white">Huzaifa</p>
//           </div>
//         </div>
//       </div>
//     </div>
